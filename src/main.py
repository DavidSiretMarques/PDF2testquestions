...
if __name__ == "__main__":
    ...
    def main(page:ft.Page):
        ...
        page.title = 'PDF to Test Questions'
        page.theme_mode = ft.ThemeMode.SYSTEM
        #page.bgcolor = ft.Colors.WHITE
        question = Question(qs[0])
        #layout = ft.Row()
        #page.add(layout)
        #layout.controls.append(QuestionList(qs))
        #layout.controls.append(question)
        page.add(QuestionList(qs))
        page.add(question)
        page.update()
    ...
    qs = [
    {
        ...
        "referencia": "Artículo 1. Objeto y ámbito de aplicación material. 1. Constituye el objeto de este Reglamento la determinación de las condiciones y los requisitos exigibles al diseño, instalación/aplicación, mantenimiento e inspección de los equipos, sistemas y componentes que conforman las instalaciones de protección activa contra incendios."
    },
    {
        ...
        "dificultad": 2,
        "creation_date": "5/11/2025",
        "referencia": "Artículo 1.2. Asimismo, el presente Reglamento se aplicará con carácter supletorio en aquellos aspectos relacionados con las instalaciones de protección activa contra incendios no regulados en las legislaciones específicas, con la excepción de los túneles de carreteras del Estado, cuya regulación en materia de seguridad se regirá por el Real Decreto 635/2006, de 26 de mayo, sobre requisitos mínimos de seguridad en los túneles de carreteras del Estado."
    },
    {
        ...
        "dificultad": 2,
        "creation_date": "5/11/2025",
        "referencia": "Artículo 2. Ámbito de aplicación subjetivo. 1. Estarán sujetos a las disposiciones de este Reglamento tanto las empresas instaladoras como las empresas mantenedoras de instalaciones de protección contra incendios. 2. Asimismo, las exigencias técnicas de este Reglamento se aplicarán a los fabricantes, importadores, distribuidores u organismos que intervengan en la certificación o evaluación técnica de los productos, y a todos aquellos que pudieran verse afectados por esta regulación."
    },
    {
        ...
        "dificultad": 1,
        "creation_date": "5/11/2025",
        "referencia": "Artículo 3. Definiciones. a) Protección activa contra incendios: es el conjunto de medios, equipos y sistemas, ya sean manuales o automáticos, cuyas funciones específicas son la detección, control y/o extinción de un incendio, facilitando la evacuación de los ocupantes e impidiendo que el incendio se propague, minimizando así las pérdidas personales y materiales."
    },
    {
